...
for input_filename in os.listdir(input_dir):
    ...
    first_phrase_input = f"Create an introductory phrase for this text of no more than 25 words. This phrase should give a meaning to the chunk, give the relevant names of the people in it and make easy to situate: {prev_chunk} {chunk}"
    ...
    with open(output_path, "w", encoding="utf-8") as f:
        ...
        f.write(f"First phrase: {first_phrase_text}\n\n")
        f.write(chunk)
        f.write(f"\n\nLast phrase: {last_phrase_text}\n\n")
